  ...
  return (
    <nav className="bg-white border">
      ...
      <ul className="hidden justify-center md:flex">
        <Link href="/">
          <li className="text-xs uppercase font-light py-5 px-10 cursor-pointer transition-all ease-in-out duration-150 hover:bg-primary-2 hover:font-normal hover:text-white">
            Home
          </li>
        </Link>
        <Link href="/about-us">
